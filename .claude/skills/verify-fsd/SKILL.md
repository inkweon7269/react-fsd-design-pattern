...
```bash
grep -rn "from '@/entities/[^']*/[^']*'" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "src/entities/" | grep -v "\.test\.\|\.spec\.\|routeTree\.gen\."
grep -rn "from '@/features/[^']*/[^']*'" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "src/features/" | grep -v "\.test\.\|\.spec\.\|routeTree\.gen\."
grep -rn "from '@/widgets/[^']*/[^']*'" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "src/widgets/" | grep -v "\.test\.\|\.spec\.\|routeTree\.gen\."
```

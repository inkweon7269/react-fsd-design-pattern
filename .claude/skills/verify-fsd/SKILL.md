...
```bash
grep -rn "from '@/entities/[^']*/" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "/entities/"
grep -rn "from '@/features/[^']*/" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "/features/"
grep -rn "from '@/widgets/[^']*/" src/ --include="*.ts" --include="*.tsx" | grep -v "node_modules" | grep -v "/widgets/"
```
